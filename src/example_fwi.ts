...
/** ignore this comment */
import { globals, fwi as fwiLib, defaults } from "./index";
...
(async() => {
    ...
    let fwi = new fwiLib.FwiCalculations();
    fwi.date = "2014-10-4 12:18:00";
    fwi.dst = 1;
    fwi.location = new globals.LatLon(49.78, -97.15);
    fwi.noonTemp = 8.0;
    fwi.noonRh = 44;
    fwi.noonPrecip = 0;
    fwi.noonWindSpeed = 18.0;
    fwi.hourlyMethod = fwiLib.FWICalculationMethod.VAN_WAGNER;
    fwi.temp = 5;
    fwi.rh = 53;
    fwi.precip = 0;
    fwi.windSpeed = 10;
    ...
    console.log(`    Hourly Calculation Method: ${fwiLib.FWICalculationMethod[fwi.hourlyMethod]}`); //output the value as a string instead of its integer representation
