...
(async function () {
    ...
    index_1.globals.WISELogger.getInstance().info('Building Prometheus job.');
    ...
    let degree_curing = prom.addGridFile(localDir + wiseVersion + '/test/degree_of_curing.asc', localDir + wiseVersion + '/test/degree_of_curing.prj', index_1.wise.GridFileType.DEGREE_CURING);
    ...
    let ws = prom.addWeatherStation(1483.0, new index_1.globals.LatLon(51.654700, -115.361700));
    let b3Yaha = ws.addWeatherStream(localDir + wiseVersion + '/test/weather_B3_hourly_Sep25toOct30_2001.txt', 94.0, 17, index_1.wise.HFFMCMethod.LAWSON, 89.0, 58.0, 482.0, 0.0, luxon_1.DateTime.fromISO("2001-09-25"), luxon_1.DateTime.fromISO("2001-10-30"));
    let wpatch = prom.addLandscapeWeatherPatch(luxon_1.DateTime.fromISO("2001-10-16T13:00:00-05:00"), index_1.globals.Duration.createTime(13, 0, 0, false), luxon_1.DateTime.fromISO("2001-10-16T21:00:00-05:00"), index_1.globals.Duration.createTime(21, 0, 0, false));
    wpatch.setWindDirOperation(index_1.wise.WeatherPatchOperation.PLUS, 10);
    wpatch.setRhOperation(index_1.wise.WeatherPatchOperation.PLUS, 5);
    let wpatch2 = prom.addFileWeatherPatch(localDir + wiseVersion + '/test/weather_patch_wd270.kmz', luxon_1.DateTime.fromISO("2001-10-16T13:00:00-05:00"), index_1.globals.Duration.createTime(13, 0, 0, false), luxon_1.DateTime.fromISO("2001-10-16T21:00:00-05:00"), index_1.globals.Duration.createTime(21, 0, 0, false));
    wpatch2.setWindDirOperation(index_1.wise.WeatherPatchOperation.EQUAL, 270);
    //create the ignition points
    let ll1 = new index_1.globals.LatLon(51.65287648142513, -115.4779078053444);
    let ig3 = prom.addPointIgnition(ll1, luxon_1.DateTime.fromISO('2001-10-16T13:00:00-05:00'));
    let ll2 = new index_1.globals.LatLon(51.66090499909746, -115.4086430000001);
    ...
    scen1.setFgmOptions(index_1.globals.Duration.createTime(0, 2, 0, false), 1.0, 1.0, 1.0, false, true, true, true, false, true, 50.0);
    //optionally set dx, dy, and dt
    scen1.setProbabilisticValues(1.0, 1.0, index_1.globals.Duration.createTime(0, 0, 10, false));
    ...
    let ovf1 = prom.addOutputVectorFileToScenario(index_1.wise.VectorFileType.KML, 'scen0/perim.kml', luxon_1.DateTime.fromISO('2001-10-16T13:00:00-05:00'), luxon_1.DateTime.fromISO('2001-10-16T22:00:00-05:00'), scen1);
    ovf1.mergeContact = true;
    ovf1.multPerim = true;
    ovf1.removeIslands = true;
    ovf1.metadata = jDefaults.metadataDefaults;
    let ogf1 = prom.addOutputGridFileToScenario(index_1.globals.GlobalStatistics.TEMPERATURE, 'scen0/temp.txt', luxon_1.DateTime.fromISO('2001-10-16T21:00:00-05:00'), index_1.wise.Output_GridFileInterpolation.IDW, scen1);
    let ogf2 = prom.addOutputGridFileToScenario(index_1.globals.GlobalStatistics.BURN_GRID, "scen0/burn_grid.tif", luxon_1.DateTime.fromISO('2001-10-16T22:00:00-05:00'), index_1.wise.Output_GridFileInterpolation.IDW, scen1);
    let ogf3 = prom.addOutputGridFileToScenario(index_1.globals.GlobalStatistics.TOTAL_FUEL_CONSUMED, 'scen0/total_fuel_consumed.tif', new index_1.globals.TimeRange(luxon_1.DateTime.fromISO('2001-10-16T14:00:00-05:00'), luxon_1.DateTime.fromISO('2001-10-16T21:00:00-05:00')), index_1.wise.Output_GridFileInterpolation.DISCRETIZED, scen1);
    ogf3.discretize = 1;
